...
--
-- Host: localhost    Database: asertiva_bmp
-- ------------------------------------------------------
...
--
-- Table structure for table `manuscript_ocde`
--

DROP TABLE IF EXISTS `manuscript_ocde`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `manuscript_ocde` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `manuscript_ocde_manuscript_id_foreign` (`manuscript_id`),
  KEY `manuscript_ocde_ocde_id_foreign` (`ocde_id`),
  CONSTRAINT `manuscript_ocde_manuscript_id_foreign` FOREIGN KEY (`manuscript_id`) REFERENCES `manuscripts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `manuscript_ocde_ocde_id_foreign` FOREIGN KEY (`ocde_id`) REFERENCES `ocdes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `manuscript_ocde`
--

LOCK TABLES `manuscript_ocde` WRITE;
/*!40000 ALTER TABLE `manuscript_ocde` DISABLE KEYS */;
INSERT INTO `manuscript_ocde` VALUES (1,2,2,NULL,NULL),(2,2,3,NULL,NULL);
/*!40000 ALTER TABLE `manuscript_ocde` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `manuscript_ods`
--

DROP TABLE IF EXISTS `manuscript_ods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `manuscript_ods` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `manuscript_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `manuscript_ods_manuscript_id_foreign` (`manuscript_id`),
  KEY `manuscript_ods_ods_id_foreign` (`ods_id`),
  CONSTRAINT `manuscript_ods_manuscript_id_foreign` FOREIGN KEY (`manuscript_id`) REFERENCES `manuscripts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `manuscript_ods_ods_id_foreign` FOREIGN KEY (`ods_id`) REFERENCES `odss` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `manuscript_ods`
--

LOCK TABLES `manuscript_ods` WRITE;
/*!40000 ALTER TABLE `manuscript_ods` DISABLE KEYS */;
INSERT INTO `manuscript_ods` VALUES (1,2,2,NULL,NULL),(2,2,15,NULL,NULL),(3,2,16,NULL,NULL);
/*!40000 ALTER TABLE `manuscript_ods` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `manuscripts` (
  ...
  `apc` tinyint(1) NOT NULL,
  `apc_value` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `q` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `index_base` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `manuscripts_country_id_foreign` (`country_id`),
  CONSTRAINT `manuscripts_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countrys` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `manuscripts` VALUES (2,'Intitucion de prueba12','Nombre de prueba','fghfghfg','carta al editor',1,'67%','Q4','REDALYC','2023-10-30','2023-12-01',1,'https://www.convocatoriasdetrabajo.com/oportunidad-laboral-practicas-sunarp-ciencias-computacion-ingenieria-software-noviembre-2023-341142.html',87,'2023-11-14 15:01:14','2023-11-14 15:01:14');
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000001_create_roles_table',1),(2,'2014_10_12_000002_create_users_table',1),(3,'2014_10_12_100000_create_password_resets_table',1),(4,'2019_08_19_000000_create_failed_jobs_table',1),(5,'2019_12_14_000001_create_personal_access_tokens_table',1),(6,'2023_11_11_201749_create_ocdes_table',1),(7,'2023_11_11_201800_create_odss_table',1),(8,'2023_11_11_201838_create_countrys_table',1),(9,'2023_11_11_201854_create_manuscripts_table',1),(10,'2023_11_11_201908_create_manuscript_ocde_table',1),(11,'2023_11_11_201923_create_manuscript_ods_table',1);
...
INSERT INTO `users` VALUES (1,'Admin','Admin','entiende@piu.com','67865676','Admin work','Admin study','Otro','2000-01-01',NULL,'$2y$10$RqCV5vQU8OIO2I69xMaWvO3DsqFMWg5wqXbNErgA2bhRaRSu2j7jC',1,NULL,'2023-11-14 14:24:00','2023-11-14 14:24:00');
...
-- Dump completed on 2023-11-14 15:20:35
